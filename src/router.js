...
const router = createRouter({
    ...
    routes: [
        ...
        {path: '/nowa_recenzja/:id', component: NewReview, name: 'new_review', meta: {require_auth: true}},
        {path: '/produkt/:id', component: ProductPage, name: 'product_page', meta: {require_auth: true}},
